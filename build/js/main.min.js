...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! exports provided: lastFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lastFocus", function() { return lastFocus; });
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    _modules_on_page_header_button_click__WEBPACK_IMPORTED_MODULE_3__["pageHeaderButton"].addEventListener('click', function () {
...
/*!***************************************************!*\
  !*** ./js/modules/on-page-header-button-click.js ***!
  \***************************************************/
/*! exports provided: pageHeaderButton, onPageHeaderButtonClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _on_page_header_button_click__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./on-page-header-button-click */ "./js/modules/on-page-header-button-click.js");
...
var themeToggle = function themeToggle(arr) {
  if (pageBody.classList.contains('page-body--dark')) {
    pageBody.classList.remove("page-body".concat(DARKMODIFIER));
    pageHeader.classList.remove("page-header".concat(DARKMODIFIER));
    switchLabel.classList.remove("page-header__switch-label".concat(DARKMODIFIER));
    _on_page_header_button_click__WEBPACK_IMPORTED_MODULE_0__["pageHeaderButton"].classList.remove("page-header__button".concat(DARKMODIFIER));
    arr.forEach(function (el) {
      el.classList.remove("nav__list-link".concat(DARKMODIFIER));
    });
    footer.classList.remove("footer".concat(DARKMODIFIER));
    mainScreenWrapper.classList.remove("main-screen__wrapper".concat(DARKMODIFIER));
  } else {
    pageBody.classList.add("page-body".concat(DARKMODIFIER));
    pageHeader.classList.add("page-header".concat(DARKMODIFIER));
    switchLabel.classList.add("page-header__switch-label".concat(DARKMODIFIER));
    _on_page_header_button_click__WEBPACK_IMPORTED_MODULE_0__["pageHeaderButton"].classList.add("page-header__button".concat(DARKMODIFIER));
    arr.forEach(function (el) {
      el.classList.add("nav__list-link".concat(DARKMODIFIER));
    });
    footer.classList.add("footer".concat(DARKMODIFIER));
    mainScreenWrapper.classList.add("main-screen__wrapper".concat(DARKMODIFIER));
  }
};
