...
/*!************************************!*\
  !*** ./js/modules/theme-switch.js ***!
  \************************************/
/*! exports provided: pageBody, pageHeader, navListLinks, switchLabel, pageHeaderButton, themeToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var pageHeaderButton = pageBody.querySelector('.page-header__button');
...
var themeToggle = function themeToggle(arr) {
  if (pageBody.classList.contains('page-body--dark')) {
    ...
    pageHeaderButton.classList.remove("page-header__button".concat(DARKMODIFIER));
    ...
    pageHeaderButton.classList.add("page-header__button".concat(DARKMODIFIER));
    arr.forEach(function (el) {
